...
$string['skillsoft_myattempt'] = 'My Attempt';
...
$string['privacy:metadata:skillsoft_report_results'] = 'Stored the data from the downloaded Custom Report so it can be processed by the plugin';
...
$string['privacy:metadata:skillsoft_tdr'] = 'Stores the data from the On Demand Connumications so it can be processed by the plugin';
