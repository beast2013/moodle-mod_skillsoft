...
//	// Adding missing 'intro' and 'introformat' field to table skillsoft
    ...
    if ($result && $oldversion < 2018022301) {
        upgrade_mod_savepoint(true, 2018022301, 'skillsoft');
        $result = true;
    }

    if ($result && $oldversion < 2018022601) {
        upgrade_mod_savepoint(true, 2018022601, 'skillsoft');
        $result = true;
    }

    if ($result && $oldversion < 2019122802) {
        upgrade_mod_savepoint(true, 2019122802, 'skillsoft');
        $result = true;
    }
