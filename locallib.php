...
define('TRACK_TO_OLSA_AUTOMATICSYNC', '3');
...
function skillsoft_get_tracking_method_array(){
	...
	TRACK_TO_OLSA_AUTOMATICSYNC => get_string('skillsoft_tracktoolsaautomaticsync', 'skillsoft'),
	);
}
...
function skillsoft_view_display($skillsoft, $user, $return=false) {
	...
	if($CFG->skillsoft_trackingmode == TRACK_TO_OLSA_AUTOMATICSYNC) {
		$element.= "<input type=\"button\" value=\"". get_string('skillsoft_enter','skillsoft') ."\" onclick=\"return openAICCWindowOLSA('$launcher', 'courseWindow',$options, false, '$CFG->wwwroot/mod/skillsoft/', '$newkey');\" />";
	} else {
